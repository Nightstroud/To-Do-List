    ...
    generateTaskHtml (list, index) {
        return `
                ...
                <div class="col-md-10 col-xs-10 col-lg-10 col-sm-10 task-text"> 
                    <p class="editable" id="clickable" onclick="toDoList.selectedList = toDoList.lists[${this.findList(list.list)}]; document.getElementById('selList').innerHTML = '${list.list}'; toDoList.selectedList.tasks.loadTasks()">${list.list}</p>
                </div>
